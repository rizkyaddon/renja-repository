...
<!--                            <div class="quoteOfDay">
                            ...
                            <div class="shortcutHome">
                                   <a <?php if($this->uniqueid == "site") echo 'class="menucurrent"'?> href="<?=Yii::app()->getBaseUrl(true)?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/photo.png" /><br />Dashboard</a>
                            </div>
                            <div class="shortcutHome">
                                   <a <?php if($this->uniqueid == "masterdata" || $this->uniqueid == "masterDataProgram" || $this->uniqueid == "masterDataKementrian") echo 'class="menucurrent"'?> href="<?=Yii::app()->getBaseUrl(true)?>/index.php/masterdata"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/masterdata.png" /><br />Master Data</a>
                            </div>
<!--                            <div class="shortcutHome">
