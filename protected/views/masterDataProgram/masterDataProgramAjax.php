...
<table style="width: 100%" class="data table">
       ...
       <?php foreach ($masters as $master): ?>
              ...
              <tr <?php if($cur_master % 2 == 0) echo 'class="tr-alt"'; else echo 'class="data"' ?>>		
                            <?php endif?>	
                     <td <?php if(count($iku_program) != 0) echo 'rowspan="'.count($iku_program).'"';  ?> class="data" data-context-menu="#tambah-indikator-utama" url-tambah="<?= Yii::app()->getBaseUrl(true)?>/index.php/ikuProgram/create/idsasaranprogram/<?=$sasaran->id_sasaran_program?>">
